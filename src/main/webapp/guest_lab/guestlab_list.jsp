...
<CENTER>
 <TABLE border=0 width=600 cellpadding=4 cellspacing=0>
  ...
  <tr align="center" bgcolor="#87E8FF"> 
   ...
   <td width="60" bgcolor="#DFEDFF"><font size="2">이름</font></td>
   <td width="100" bgcolor="#DFEDFF"><font size="2">핸드폰</font></td>
   <td width="80" bgcolor="#DFEDFF"><font size="2">성별</font></td>
   <td width="60" bgcolor="#DFEDFF"><font size="2">주소</font></td>
  </tr>
  <tr align="center"> 
...
<!-- JSP 코드 블락 : DB의 레코드를 가져와서 루프 : 시작 -->
	...
	int maxpages = 2;		//하단의 페이지 출력 부분에서 출력할 최대 페이지 갯수	
	int startpage = 1;
 ...
 <TR>
  <TD align=right width="241"> 
   <SELECT name=stype >
    ...
    <OPTION value=2 >핸드폰
    <OPTION value=3 >성별
    <OPTION value=4 >이름+핸드폰
    <OPTION value=5 >이름+성별
    <OPTION value=6 >이름+주소
    <OPTION value=7 >이름+핸드폰+성별
   </SELECT>
  </TD>

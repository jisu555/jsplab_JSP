...
<body>
	...
	<form name="filemember" method = "post" action = "update02_process.jsp"> 
   ...
   <td colspan="2" align="right"> 
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
     <tr> 
      ...
      <td width="12%"><A href="list02.jsp?go=<%= request.getParameter("page") %>"> <img src="images/list.jpg" border=0></a></td>
     </tr>
			</table>

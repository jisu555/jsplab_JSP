...
<table border=0 width = "800" >
	...
	String em = null;
		...
		for (int j = startrow; j <= endrow ; j++){
			...
			<tr align="center">
				...
				<td> <a href="read02.jsp?id=<%= keyidx.elementAt(j) %>&page=<%=where%>">
						<%= id.elementAt(j) %></a></td>
 ...
 <FORM method="post" name="memsearch" action="search02.jsp">
<TABLE border=0 width=600 cellpadding=0 cellspacing=0>
 <TR>
  ...
  <TD align=right valign=bottom width="117"><A href="Insert02.jsp"><img src="images/write.gif" border="0"></TD>
 </TR>
</TABLE>
</FORM>
